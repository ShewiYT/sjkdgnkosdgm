  ...
  return (
    <div className="p-6 space-y-6 animate-fade-in overflow-y-auto max-h-[calc(100vh-52px)]">
      <div>
        ...
        <p className="text-sm text-white/40 mt-1">Обзор безопасности аккаунтов</p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="glass-card rounded-2xl p-4 bg-gradient-to-br from-green-500/10 to-green-600/5">
          ...
          <div className="text-2xl font-bold text-white">{guardedCount}</div>
          <div className="text-xs text-white/50">Guard включен</div>
        </div>
        <div className="glass-card rounded-2xl p-4 bg-gradient-to-br from-blue-500/10 to-blue-600/5">
          <Lock size={20} className="text-blue-400 mb-2" />
          <div className="text-2xl font-bold text-white">{cleanCount}</div>
          <div className="text-xs text-white/50">Чистых аккаунтов</div>
        </div>
        <div className="glass-card rounded-2xl p-4 bg-gradient-to-br from-red-500/10 to-red-600/5">
          ...
          <div className="text-xs text-white/50">С банами</div>
        </div>
        <div className="glass-card rounded-2xl p-4 bg-gradient-to-br from-yellow-500/10 to-yellow-600/5">
          ...
          <div className="text-2xl font-bold text-white">{limitedCount}</div>
          <div className="text-xs text-white/50">Limited</div>
        </div>
      </div>

      <div className="glass-card rounded-2xl overflow-hidden">
        <div className="px-4 py-3 border-b border-white/5">
          <h3 className="text-sm font-semibold text-white">Детали безопасности</h3>
        </div>
        <div className="divide-y divide-white/5">
          ...
          {accounts.length === 0 && (
            <div className="px-4 py-8 text-center text-xs text-white/30">Нет аккаунтов</div>
          )}
        </div>
      </div>
    </div>
