...
const menuItems: MenuItem[] = [
  { view: 'import', icon: <Upload size={16} />, label: 'Импорт' },
  ...
  { view: 'sda', icon: <Lock size={16} />, label: 'SDA / Guard' },
...
export default function Sidebar({
  ...
  return (
    <div
      className={`flex flex-col border-r border-white/5 bg-dark-800/50 transition-all duration-300 ${
        collapsed ? 'w-14' : 'w-52'
      } shrink-0`}
    >
      {/* Logo */}
      <div className="flex items-center gap-3 px-3 py-4 border-b border-white/5">
        ...
        {!collapsed && (
          <div className="min-w-0">
            <div className="text-sm font-semibold text-white truncate">SukaCombine</div>
